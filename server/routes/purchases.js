...
const purchases = (req, res) => {
    ...
    jasminReq('get', '/invoiceReceipt/invoices').then((data) => {
        data.forEach((invoice) => {
            ...
            invoice.documentLines.forEach((item) => {
                ...
                response.push({ key: key, name: name, supplier: supplier, date: date, quantity: quantity, unitCost: unitCost });
            });
        });
    ...
    jasminReq('get', '/invoiceReceipt/invoices').then((data) => {
        data.forEach((invoice) => {
            ...
            invoice.documentLines.forEach((item) => {
                ...
                response.push({ key: key, name: name, supplier: supplier, dueDate: dueDate, quantity: quantity, unitCost: unitCost, totalCost: totalCost });
            });
        });
